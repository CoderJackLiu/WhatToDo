...
#### 🐛 Bug 修复
- **修复 PowerShell 脚本编码问题** - 修复 `generate-latest-yml.ps1` 脚本的编码问题，确保正确生成 latest.yml 文件

#### 🔧 技术改进
- 优化 `generate-latest-yml.ps1` 脚本，使用 UTF-8 编码保存文件
- 改进脚本错误处理和文件路径处理

#### 📦 文件变更
- 修改：`scripts/generate-latest-yml.ps1` - 修复编码问题，优化文件保存逻辑
